"""
Django settings for Hakathonweb3 project.
...
SECRET_KEY = 'django-insecure-js8t4n=^la#pl1d-jfa3(7mhp@+3*36co-=%(o$!mc!r4&(p53'
...
WSGI_APPLICATION = 'Hakathonweb3.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'anon': '10/hour',
        'login': '5/minute',
        'register': '3/hour', # Each anonymous user is limited to 10 requests per hour
    }
}
